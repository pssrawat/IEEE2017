...
extern "C" void hypterm_gold (float *flux_in_0, float *flux_in_1, float *flux_in_2, float *flux_in_3, float *flux_in_4, float *cons_in_1, float *cons_in_2, float *cons_in_3, float *cons_in_4, float *q_in_1, float *q_in_2, float *q_in_3, float *q_in_4, float *dxinv, int N) {
  float (*flux_0)[N][N] = (float (*)[N][N])flux_in_0;
  float (*flux_1)[N][N] = (float (*)[N][N])flux_in_1;
  float (*flux_2)[N][N] = (float (*)[N][N])flux_in_2;
  float (*flux_3)[N][N] = (float (*)[N][N])flux_in_3;
  float (*flux_4)[N][N] = (float (*)[N][N])flux_in_4;
  float (*cons_1)[N][N] = (float (*)[N][N])cons_in_1;
  float (*cons_2)[N][N] = (float (*)[N][N])cons_in_2;
  float (*cons_3)[N][N] = (float (*)[N][N])cons_in_3;
  float (*cons_4)[N][N] = (float (*)[N][N])cons_in_4;
  float (*q_1)[N][N] = (float (*)[N][N])q_in_1;
  float (*q_2)[N][N] = (float (*)[N][N])q_in_2;
  float (*q_3)[N][N] = (float (*)[N][N])q_in_3;
  float (*q_4)[N][N] = (float (*)[N][N])q_in_4;
  int i, j, k;
