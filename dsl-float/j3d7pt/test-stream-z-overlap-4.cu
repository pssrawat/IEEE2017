...
/* Device code Begin */
/* X, Y, Z */
__global__ void __kernel___forma_kernel__0__(float * input, int L, int M, int N, int FORMA_BLOCKDIM_X, int FORMA_BLOCKDIM_Y, int FORMA_BLOCKDIM_Z, float * __var_1__){
