...
__global__ void __kernel___forma_kernel__0__(float * __restrict__ input, int L, int M, int N, int FORMA_BLOCKDIM_X, int FORMA_BLOCKDIM_Y, int FORMA_BLOCKDIM_Z, float * __restrict__ __var_1__){
  ...
  int __iter_0__ = (int)(blockIdx.x)*((int)(FORMA_BLOCKDIM_X)-6);
  int __iter_1__ = (int)(blockIdx.y)*((int)(FORMA_BLOCKDIM_Y)-6);
  float t3=0.0f, t4=0.0f, t5=0.0f;
  float b3=0.0f, b4=0.0f, b5=0.0f;
...
int __blockSizeToSMemSize___kernel___forma_kernel__0__(dim3 blockDim){
  ...
  int SMemSize = 0;
  SMemSize += sizeof(float)*(3*FORMA_BLOCKDIM_Y*FORMA_BLOCKDIM_X);
  return SMemSize;
}
...
/* Kernel Launch Begin */
  ...
  int __grid_0___kernel___forma_kernel__0__ = FORMA_CEIL(__size_0___kernel___forma_kernel__0__,__blockConfig___kernel___forma_kernel__0__.x-6);
  int __grid_1___kernel___forma_kernel__0__ = FORMA_CEIL(__size_1___kernel___forma_kernel__0__,__blockConfig___kernel___forma_kernel__0__.y-6);
