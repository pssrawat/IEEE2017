...
__global__ void __kernel___forma_kernel__0__(double * __restrict__ input, int N, int M, double * __restrict__ __var_4__){
  ...
  if(__iter_0__ <= (M-2)){
    ...
    if(__iter_1__ <= (N-2)){
      ...
      double __temp_3__;
      __temp_3__ = (0.000100 + __temp_2__);
      double __temp_4__;
      ...
      double __temp_17__;
      __temp_17__ = (1.000000 / __temp_16__);
      double __temp_18__;
...
__global__ void __kernel___forma_kernel__1__(double * __restrict__ __var_4__, int N, int M, double * __restrict__ __var_3__){
  ...
  if(__iter_2__ <= (M-2)){
    ...
    if(__iter_3__ <= (N-2)){
      ...
      double __temp_22__;
      __temp_22__ = (0.000100 + __temp_21__);
      double __temp_23__;
      ...
      double __temp_36__;
      __temp_36__ = (1.000000 / __temp_35__);
      double __temp_37__;
...
__global__ void __kernel___forma_kernel__2__(double * __restrict__ __var_3__, int N, int M, double * __restrict__ __var_2__){
  ...
  if(__iter_4__ <= (M-2)){
    ...
    if(__iter_5__ <= (N-2)){
      ...
      double __temp_41__;
      __temp_41__ = (0.000100 + __temp_40__);
      double __temp_42__;
      ...
      double __temp_55__;
      __temp_55__ = (1.000000 / __temp_54__);
      double __temp_56__;
...
__global__ void __kernel___forma_kernel__3__(double * __restrict__ __var_2__, int N, int M, double * __restrict__ __var_1__){
  ...
  if(__iter_6__ <= (M-2)){
    ...
    if(__iter_7__ <= (N-2)){
      ...
      double __temp_60__;
      __temp_60__ = (0.000100 + __temp_59__);
      double __temp_61__;
      ...
      double __temp_74__;
      __temp_74__ = (1.000000 / __temp_73__);
      double __temp_75__;
