...
extern "C" void j3d17pt(double*, int, int, int, double*);

extern "C" void j3d17pt_gold(double*, int, int, int, double*);
...
int main(int argc, char** argv) {
  ...
  j3d17pt((double*)input, height, width_y, width_x, (double*)output);

  j3d17pt_gold((double*)input, height, width_y, width_x, (double*)output_gold);
