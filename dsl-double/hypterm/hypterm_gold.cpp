...
extern "C" void hypterm_gold (double *flux_in_0, double *flux_in_1, double *flux_in_2, double *flux_in_3, double *flux_in_4, double *cons_in_1, double *cons_in_2, double *cons_in_3, double *cons_in_4, double *q_in_1, double *q_in_2, double *q_in_3, double *q_in_4, double *dxinv, int N) {
  double (*flux_0)[N][N] = (double (*)[N][N])flux_in_0;
  double (*flux_1)[N][N] = (double (*)[N][N])flux_in_1;
  double (*flux_2)[N][N] = (double (*)[N][N])flux_in_2;
  double (*flux_3)[N][N] = (double (*)[N][N])flux_in_3;
  double (*flux_4)[N][N] = (double (*)[N][N])flux_in_4;
  double (*cons_1)[N][N] = (double (*)[N][N])cons_in_1;
  double (*cons_2)[N][N] = (double (*)[N][N])cons_in_2;
  double (*cons_3)[N][N] = (double (*)[N][N])cons_in_3;
  double (*cons_4)[N][N] = (double (*)[N][N])cons_in_4;
  double (*q_1)[N][N] = (double (*)[N][N])q_in_1;
  double (*q_2)[N][N] = (double (*)[N][N])q_in_2;
  double (*q_3)[N][N] = (double (*)[N][N])q_in_3;
  double (*q_4)[N][N] = (double (*)[N][N])q_in_4;
  int i, j, k;
