  ...
  for (int __iter_1__ = 0; __iter_1__ <= N-1; __iter_1__ += FORMA_BLOCKDIM_Y) {
    ...
    if( __iter_4__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-2),(N-2)) ){
      ...
      if( __iter_5__ <= FORMA_MIN(((__iter_0__+GAPX+1)-1),(M-2)) ){
        float __temp_2__ = (__tilevar_0__[__iter_5__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_4__-1),rowy)]);
        float __temp_5__ = (__tilevar_0__[__iter_5__+(-1)+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_4__,rowy)]);
        float __temp_6__ = (5 * __temp_2__ + 12 * __temp_5__);
        float __temp_9__ = (__tilevar_0__[__iter_5__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_4__,rowy)]);
        float __temp_10__ = (__temp_6__ + 15 * __temp_9__);
        float __temp_13__ = (__tilevar_0__[__iter_5__+1+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_4__,rowy)]);
        float __temp_14__ = (__temp_10__ + 12 * __temp_13__);
        float __temp_17__ = (__tilevar_0__[__iter_5__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_4__+1),rowy)]);
        float __temp_18__ = (__temp_14__ + 5 * __temp_17__);
        float __temp_19__ = (__temp_18__ / 118);
    ...
    if( __iter_10__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-3),(N-2)) ){
      ...
      if( __iter_11__ <= FORMA_MIN(((__iter_0__+GAPX+2)-1),(M-2)) ){
        float __temp_32__ = (__tilevar_1__[__iter_11__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_10__-1),rowy)]);
        float __temp_35__ = (__tilevar_1__[__iter_11__+(-1)+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_10__,rowy)]);
        float __temp_36__ = (5 * __temp_32__ + 12 * __temp_35__);
        float __temp_39__ = (__tilevar_1__[__iter_11__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_10__,rowy)]);
        float __temp_40__ = (__temp_36__ + 15 * __temp_39__);
        float __temp_43__ = (__tilevar_1__[__iter_11__+1+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_10__,rowy)]);
        float __temp_44__ = (__temp_40__ + 12 * __temp_43__);
        float __temp_47__ = (__tilevar_1__[__iter_11__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_10__+1),rowy)]);
        float __temp_48__ = (__temp_44__ + 5 * __temp_47__);
        float __temp_49__ = (__temp_48__ / 118);
    ...
    if( __iter_16__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-4),(N-2)) ){
      ...
      if( __iter_17__ <= FORMA_MIN(((__iter_0__+GAPX+3)-1),(M-2)) ){
        float __temp_60__ = (__tilevar_0__[__iter_17__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_16__-1),rowy)]);
        float __temp_61__ = (__tilevar_0__[__iter_17__+(-1)+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_16__,rowy)]);
        float __temp_62__ = (5 * __temp_60__ + 12 * __temp_61__);
        float __temp_63__ = (__tilevar_0__[__iter_17__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_16__,rowy)]);
        float __temp_64__ = (__temp_62__ + 15 * __temp_63__);
        float __temp_65__ = (__tilevar_0__[__iter_17__+1+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_16__,rowy)]);
        float __temp_66__ = (__temp_64__ + 12 * __temp_65__);
        float __temp_67__ = (__tilevar_0__[__iter_17__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_16__+1),rowy)]);
        float __temp_68__ = (__temp_66__ + 5 * __temp_67__);
        float __temp_69__ = (__temp_68__ / 118);
    ...
    if( __iter_22__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-5),(N-2)) ){
      ...
      if( __iter_23__ <= FORMA_MIN(((__iter_0__+GAPX+4)-1),(M-2)) ){
        float __temp_80__ = (__tilevar_1__[__iter_23__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_22__-1),rowy)]);
        float __temp_81__ = (__tilevar_1__[__iter_23__+(-1)+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_22__,rowy)]);
        float __temp_82__ = (5 * __temp_80__ + 12 * __temp_81__);
        float __temp_83__ = (__tilevar_1__[__iter_23__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_22__,rowy)]);
        float __temp_84__ = (__temp_82__ + 15 * __temp_83__);
        float __temp_85__ = (__tilevar_1__[__iter_23__+1+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod(__iter_22__,rowy)]);
        float __temp_86__ = (__temp_84__ + 12 * __temp_85__);
        float __temp_87__ = (__tilevar_1__[__iter_23__+(EXTENT-__iter_0__)+FORMA_BLOCKDIM_X*mod((__iter_22__+1),rowy)]);
        float __temp_88__ = (__temp_86__ + 5 * __temp_87__);
        float __temp_89__ = (__temp_88__ / 118);
        __var_1__[__iter_23__+(M)*(__iter_22__)] = __temp_89__;
      }
