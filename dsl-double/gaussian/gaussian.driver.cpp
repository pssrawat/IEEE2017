...
extern "C" void gaussian(double*, int, int, double*);

extern "C" void gaussian_gold(double*, int, int, double*);
...
int main(int argc, char** argv) {
  ...
  gaussian((double*)input, width_y, width_x, (double*)output);

  gaussian_gold((double*)input, width_y, width_x, (double*)output_gold);
