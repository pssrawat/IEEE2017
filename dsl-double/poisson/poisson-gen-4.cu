...
__global__ void possion (double * __restrict__ in, double * __restrict__ out, double * __restrict__ out1, double * __restrict__ out2, double * __restrict__ out3, int L, int M, int N) {
  ...
  //Declarations
  double __shared__ sh_in_c0[32][32];
  double __shared__ sh_out_m1[32][32];
  double reg_out_c0=0, reg_out_p1=0;
  double __shared__ sh_out1_m2[32][32];
  double reg_out1_m1=0, reg_out1_c0=0;
  double __shared__ sh_out2_m3[32][32];
  double reg_out2_m2=0, reg_out2_m1=0;
  double reg_out3_m4=0, reg_out3_m3=0, reg_out3_m2=0;
...
extern "C" void host_code (double *h_in, double *h_out3, int L, int M, int N) {
  double *in;
  ...
  cudaMemcpy (h_out3, out3, sizeof(double)*L*M*N, cudaMemcpyDeviceToHost);
